...
link del repo espejo local con la configuracion del cluster. Las .env cambian en las variables propias de cada ec2.
C:\Users\ASUS\Desktop\RIWI\ruta-avanzada\m6\analitica\keppler\repos\cluster-config
