...
from pipelines.tasks.caso_5.eda.lendingClub.rejected.parquet_task import (
    convert_lending_rejected_to_parquet,
)
...
def ingest_rejected_lending() -> str:

    print(
        "Iniciando ingesta Lending Rejected"
    )
...
if __name__ == "__main__":
    result = ingest_rejected_lending()
